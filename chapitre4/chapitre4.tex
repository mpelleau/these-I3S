...
\begin{epigraphe}[english]{Alan J. Perlis}{Epigrams on Programming}
  It is easier to write an incorrect program than understand a correct one.
\end{epigraphe}

\begin{epigraphe}{Alan J. Perlis}{Epigrams on Programming}
...
\begin{block}{Un bloc}
  Avec du texte sur un fond en couleur.
\end{block}

\begin{block-line}
Un block mais juste avec une ligne avant et une ligne après.\\
\end{block-line}
